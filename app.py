...
# --- ÁREA DOS PAIS/ALUNOS ---
    ...
    if not df.empty:
        t_f = st.selectbox("Escolha a Turma do Aluno:", ["Selecione..."] + sorted(list(df['Turma'].unique())))
        if t_f != "Selecione...":
    ...
    st.warning("⚠️ Selecione o perfil e insira a senha na barra lateral para acessar.")
